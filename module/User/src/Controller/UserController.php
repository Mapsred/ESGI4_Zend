...
class UserController extends AbstractActionController
{
    ...
    public function resetPasswordAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            // Validate form
            if ($form->isValid()) {
                if (null != $user = $this->entityManager->getRepository(User::class)->findOneByEmail($data['email'])) {
                    // Generate a new password for user and send an E-mail notification about that.
    ...
    public function setPasswordAction()
    {
        ...
        if ($this->getRequest()->isPost()) {
            ...
            if ($form->isValid()) {
                $data = $form->getData();
                $messageId = $this->userManager->setNewPasswordByToken($token, $data['new_password']) ? 'set' : 'failed';

                return $this->redirect()->toRoute('users', ['action' => 'message', 'id' => $messageId]);
            }
        }
